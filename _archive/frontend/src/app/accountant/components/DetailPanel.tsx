                        ...
                        <div className="px-5 py-4 border-t border-[#DFE1E6] bg-[#FAFBFC]">
                            <div className="flex items-center gap-2">
                                <button
                                    ...
                                    className={`flex-1 flex items-center justify-center gap-2 px-4 py-2 text-white text-[13px] font-medium rounded transition-colors ${
                                        isSendingReminder
                                            ? "bg-[#0052CC]/60 cursor-not-allowed"
