module.exports = [
"[project]/.next-internal/server/app/api/uploadthing/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const ourFileRouter = {
    ...
    documentUploader: f({
    ...
    }).input(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        clientId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string(),
        checklistItemId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string()
    })).middleware(async ({ input })=>{
        const { clientId, checklistItemId } = input;
        // Verify the checklist item exists
        const checklistItem = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].checklistItem.findUnique({
            where: {
                id: checklistItemId
            },
            include: {
        ...
        if (!checklistItem || checklistItem.clientSetupId !== clientId) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$uploadthing$2f$shared$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UploadThingError"]("Invalid checklist item");
        }
        return {
            clientId,
            checklistItemId,
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].checklistItem.update({
            where: {
                id: metadata.checklistItemId
            },
            data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__635f6e05._.js.map